...
%% Secinajums
% * Izmantojot funkciju uzzimejam signalu
%%
% * Iemacijos noteikt vajadzigos ciparus pa Y un X ass
%%
% * Iemacijos izmantot grid un axis funkciju
%%
% * Noskaidroju ka mainit plot linijas krasu un izmeru 